...
<section id="detail">
    <div class="container">
        ...
        <p class="date">25d 14u 44m  <span>(7 bids)</span><span class="icon"></span></p>
        ...
        <div class="detail">
            <div class="row">
                <div class="col-sm-8 no-padding">
                    <div class="detail-pictures">
                        <div class="main">
                            <img src="../images/detail/camera.jpg" alt="camera">
                        </div>
                        <div class="thumbnails">
                            <a class="col-sm-4">
                                <div class="overlay"></div>
                                <img src="../images/detail/closeup.jpg" alt="closeup">
                            </a>
                            <a class="col-sm-4">
                                <div class="overlay"></div>
                                <img src="../images/detail/mouse.jpg" alt="mouse">
                            </a>
                            <a class="col-sm-4">
                                <div class="overlay"></div>
                                <img src="../images/detail/window.jpg" alt="window">
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12 info-auction">
                    <div class="col-sm-9">
                        <div class="text">
                            <h6>Description</h6>
                            <p>"Dance of Time III" (1979-84) is a stunning bronze and gold patina sculpture<br />
